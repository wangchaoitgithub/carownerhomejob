...
final class Response
{
    ...
    public function __construct($code, $duration, array $headers = array(), $body = null, $error = null)
    {
        ...
        $json_verify = getConfig("FORMAT_VERIFY");
        if (self::isJson($headers,$json_verify)) {
            try {
    ...
    {
        return miguJsonDecode((string) $body, true, 512);
    }
    ...
    private static function isJson($headers,$verify=FALSE)
    {
      if(!$verify){
        return TRUE;
      }
